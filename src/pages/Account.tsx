        ...
        <div className="max-w-[1200px] mx-auto flex flex-col md:flex-row px-16 gap-10">
          ...
          <aside className="w-full lg:w-[250px] flex flex-col gap-4">
            <div className="bg-white border border-gray-300">
              <h2 className="text-gray-700 bg-gray-200 text-lg py-2 px-2">
                Your account
              </h2>
              <div className="flex flex-col py-2">
                ...
                <a href="#" className="w-full p-2 text-[#343637]">
                  Alerts
                </a>
                <a href="#" className="w-full p-2 text-[#343637]">
                  Reaction given
                ...
                <a href="#" className="w-full p-2 text-[#343637] border-b border-gray-300">
                  Bookmarks
                </a>
                <h2 className="text-yellow-400 p-2">Settings</h2>
                <a href="#" className="w-full bg-gray-300 p-2 font-semibold text-[#343637]">
                  Account details
                </a>
                <a href="#" className="w-full p-2 text-[#343637]">
            ...
            <div className="border border-gray-300 flex flex-col py-2 gap-2">
              <a href="/logout" className="w-full p-2 text-[#343637]">
                LogOut
              </a>
            </div>
          </aside>
          ...
          <section className="w-full max-w-[600px] bg-white border border-gray-300 rounded-lg p-8 text-[#343637] shadow-md">
            <div className="mb-8">
                <h2 className="text-2xl font-semibold mb-3 border-b border-yellow-400 pb-2">
                Username
                </h2>
                <p className="text-2xl font-bold mb-1">{username}</p>
                <p className="text-sm text-gray-500">
                You may next change your username on or after <span className="font-semibold text-yellow-500">{new Date().getDate()}/{new Date().getMonth()}/{new Date().getFullYear()}</span>.
                </p>
            </div>
